...
import com.dh.catalogservice.repository.FeingMovie;
...
@Service
public record CatalogServiceImpl(FeignSerie feignSerie, CatalogRepository catalogRepository, FeingMovie feignMovie) implements CatalogService {
    ...
    @Override
    public List<? extends Pattern> getCatalogByGenre2(String genre) {
        return feignMovie.listByGenre(genre);
    }
